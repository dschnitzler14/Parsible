...
These include original studies generating new data, as well as studies like meta-analyses, which use existing datasets that are analysed differently. Important to note, meta-analyses are different from systemic reviews.